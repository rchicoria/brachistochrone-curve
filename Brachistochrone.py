...
def sga(x1, y1, x2, y2, ngeracoes, nindividuos, ngenes, seleccao_pais, fitness, func_mutacao,
		seleccao_sobreviventes, tamanho_torneio, prob_crossover, prob_mutacao, tamanho_elite):
	...
	for geracao in xrange(ngeracoes):
		...
		print "Melhor descendente da geração %d: %f" % (geracao, descendentes[0][1])
	# continua...
...
if __name__ == '__main__':
	...
	# faz os cálculos
	sga(x1, y1, x2, y2, ngeracoes, nindividuos, ngenes,0,0,0,0,3,0,0.5,0)
